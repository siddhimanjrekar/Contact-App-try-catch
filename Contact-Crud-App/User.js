...
class User {
    ...
    // updateContactName(contactId, newValue) {
    //     try {
    //         if(this.isAdmin){
    //             throw new UnAuthorizedError("you are admin")
    //         }
    ...
    //         }
    //         this.contacts[indexOfContact].updateContactFullName(newValue)
    //         // this.contacts[indexOfContact].updateCountry(newValue)
    //         return this.contacts[indexOfContact]
    //     } catch (error) {
    //         return error
    //     }
    // }
    // updateContactCountry(contactId, newValue) {
    //     try {
    //         if(this.isAdmin){
    //             throw new UnAuthorizedError("you are admin")
    //         }
...
let admin = User.newAdmin("Siddhi Manjrekar", "Female", 22)
console.log(admin);

//Create user
console.log("Create user:");
let user1 = admin.newUser("Suhas Manjrekar","Male",50)
console.log(user1);
let user2 = admin.newUser("Swati Manjrekar", "Female",50)
console.log(user2);
let user3 = admin.newUser("abc def", "Female",10)
console.log(user3);
...
// update user
let updateuser3 = admin.updateUser(3, "fullName", "Suman Manjrekar")
...
user1.createContact("Siddhi Manjrekar contact", "India")
user1.createContact("Suhas Manjrekar contact", "Australia")
user1.createContact("Swati Manjrekar contact", "Srilanka")
...
console.log(user1.updateContact(2, "fullName","Swati Contact")); 
